...
const { writeInputSubject, readInputSubject } = require('../controllers/Inputsubject');
...
const { readRoom, writeRoom, readLab, writeLab } = require('../controllers/room');
const { generateTimeTableForRoom, generateTimeTableForTeacherView, getRoomTTView, getClassTTView } = require('../controllers/timeTableRoom');
